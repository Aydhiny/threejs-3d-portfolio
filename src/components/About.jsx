...
const ServiceCard = ({index, title, icon, link}) => {
  return (
    <Tilt className="xs:justify-center xs:w-[250px] w-full">
      ...
      <div options={{
        ...
        scale: 1,
        speed: 450
        }} className='bg-tertiary rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col cursor-pointer ' onClick={() => window.open(link, '_blank')}>
